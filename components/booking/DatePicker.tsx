    ...
    <div
      ...
      <div className="flex mb-4 text-xl font-light text-gray-600">
        <span className="w-1/2 text-gray-600 dark:text-white">
          ...
          <span className="text-gray-100">{inviteeDate().format("YYYY")}</span>
        </span>
        <div className="w-1/2 text-right text-gray-600 dark:text-gray-100">
          <button
      ...
      <div className="grid grid-cols-7 gap-4 text-center border-t border-b dark:border-gray-800 sm:border-0">
        {["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"]
          ...
          .map((weekDay) => (
            <div key={weekDay} className="my-4 text-xs tracking-widest text-gray-100 uppercase">
